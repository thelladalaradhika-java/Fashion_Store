...
//            if (size == null) size = "M";
//
//            // Dynamic setup allocation rules
//            CartItem newItem;
//            if (productId == 2) {
//                newItem = new CartItem(2, "Blue Slim Fit Jeans", "Levis", 960.00, size, 1, "jeans.jpg");
//            } else {
//                newItem = new CartItem(1, "T-Shirt", "PUMA", 500.00, size, 1, "shirt.jpg");
//            }
//
//            // Check if item with same ID and size exists to merge quantity
//            boolean exists = false;
//            for (CartItem item : cart) {
//                if (item.getId() == newItem.getId() && item.getSize().equals(newItem.getSize())) {
